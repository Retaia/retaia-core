...
- affected endpoint, command, workflow, or component
...
- dependency and container update configuration

Operational incidents outside this repository, third-party service outages, and unsupported forks are out of scope for this policy.
